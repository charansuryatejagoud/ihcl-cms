...
export const business: FeatureSchemaDefinition = {
  variants: {
    group: [
      {
        title: '[Business Services] FactSheet Download Action with Background Image',
    ...
    card: [
      {
        title: '[Business Services] center Aligned Title Description with Actions',
