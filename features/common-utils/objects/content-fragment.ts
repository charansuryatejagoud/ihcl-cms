...
import {isAdminUser} from '../../../utils/shared-utils'
import {Rule} from 'sanity'
import {client} from '../../../plugins/read-excel/client'

export class ContentFragment extends Content {
      ...
      fields: [
        ...
        },
        {
          ...
          validation: (Rule: Rule) =>
            Rule.required().custom(async (path, {document}: any) => {
        ...
        },
        {
          ...
          type: 'array',
          of: [...(items?.groupItems ?? [])],
          hidden: ({parent}: any) => !parent?.isNestedFragment,
        },
        {
          name: 'documents',
          title: 'Documents',
