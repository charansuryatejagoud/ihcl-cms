...
export const holidays: FeatureSchemaDefinition = {
  variants: {
    group: [
      {
        title: '[Holiday Details] Group With 3 Column Cards Grid(Layout Placeholder)',
        value: 'ihcl.core.group.group-with-3-column-cards-grid-holiday-layout-placeholder',
      },
      {
        title: '[Holiday Details] Highlighted 2 Card Carousel(Layout Placeholder)',
        value: 'ihcl.core.group.highlighted-2-card-carousel-layout-placeholder',
      },
      {
        title: '[Holiday Details] Group With Card Left Media Right Content(Layout Placeholder)',
        value:
