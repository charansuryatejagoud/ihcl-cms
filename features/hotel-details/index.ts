...
export const hotelDetails: FeatureSchemaDefinition = {
  variants: {
    connectedStores: [
      {
    ...
    group: [
      ...
      {
        title: '[Details] Group With Rich Text Columns',
        value: 'details.group.group-with-rich-text-columns',
      },
      {
        title: '[Details] Group With Maps',
      ...
      },
      {
        ...
        value: 'details.group.group-with-card-right-media-left-content-aspect-ratio-2:4-hotel',
      },
      {
      ...
      },
      {
        ...
        value: 'details.group.destination.navigation-tabs',
      },
      {
    ...
    card: [
      {
        title: '[Details] Award Card',
        value: 'details.card.award-card',
      },
      {
        title: '[Details] Card With Side Text',
        value: 'details.card.card-with-side-text',
      },
      {
        title: '[Details] 3 Actions With Right Aligned Content Card',
        value: 'details.card.3-actions-with-right-aligned-content-card',
      },
      {
        title: '[Details] Card With Right Aligned Content',
      ...
      },
      {
        ...
        value: 'details.card.card-with-left-media-right-content-aspect-ratio-2:2',
      },
      {
