...
export const Authentication: FeatureSchemaDefinition = {
  variants: {
    group: [
        {title: "[Authentication] Maps with Aspect Ratio (6:6)", value: "authentication.group.maps-with-aspect-ratio-6:6"}
    ],
    card: [
        {
    ...
    nudge: [
        { title: "[Authentication] Details Form", value: "authentication.nudge.details-form"},
        { title: "[Authentication] Address Form", value: "authentication.nudge.address-form"},
        { title: "[Authentication] Fields with Actions", value: "authentication.nudge.fields-with-actions"},
